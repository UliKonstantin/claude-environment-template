...
Starts FastAPI server with hot-reload on port 8000. SQLite database is created automatically on first run.
...
- No environment file (.env) required by default - uses SQLite with sensible defaults
